        ...
        <div class="row">
            ...
            <div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
                <div class="heading-section-bold mb-4 mt-md-5">
                    <div class="ml-md-0">
                        <h2 class="mb-4">Welcome to SISPERTWEB Website</h2>
                    </div>
                </div>
                <div class="pb-md-5">
                    <p>Selamat Datang di Sispertweb!<br>
Kami adalah tim yang berkomitmen untuk membawa Anda pengalaman makanan sehat yang lezat dan bermanfaat. Di Sayuran Menu, kami percaya bahwa makanan sehat adalah kunci untuk hidup yang lebih baik. Itulah mengapa kami dengan bangga menyajikan beragam hidangan sayuran segar dan lezat untuk memenuhi kebutuhan nutrisi Anda.Kami sangat menghargai dukungan Anda dan berharap Anda menemukan apa yang Anda cari di Sispertweb.<br>

Terima kasih telah memilih kami sebagai destinasi makanan sehat Anda.
Kami berharap dapat memberikan pengalaman kuliner yang tak terlupakan
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
            <div class="col-md-7 heading-section ftco-animate text-center">
                ...
                <p>Saya seorang vegetarian dan situs ini
adalah penyelamat bagi saya!Saya selalu
 menemukan sayuran organik yang segar
 dan bermutu tinggi di sini.Layana pelanggan
 yang ramah membuat pengalaman
 berbelanja lebih baik."</p>
            </div>
        </div>
